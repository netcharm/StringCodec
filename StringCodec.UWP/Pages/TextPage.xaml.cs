...
namespace StringCodec.UWP.Pages
{
    ...
    public sealed partial class TextPage : Page
    {
        ...
        {
            ToggleMenuFlyoutItem[] opts = new ToggleMenuFlyoutItem[] { optBase64, optUUE, optXXE, optURL, optThunder, optRaw, optQuoted };
        ...
        {
            ToggleMenuFlyoutItem[] opts = new ToggleMenuFlyoutItem[] { optUTF8, optUnicode };
